<template>
  <div class="h-screen overflow-hidden flex bg-gray-50 font-public-sans">
    ...
    >
      ...
      <nav class="flex-1 overflow-y-auto overflow-x-hidden p-4 space-y-1">
        <NavItem to="/admin-patient/dashboard"  :icon="LayoutDashboard" label="Dashboard" />
        <NavItem to="/admin-patient/patients"   :icon="Users" label="Patients" />
      </nav>
